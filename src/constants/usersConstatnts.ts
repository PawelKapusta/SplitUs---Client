...
export const USER_DELETE_RESET: string = "USER_DELETE_RESET";
...
export const USER_ADMIN_UPDATE_FAIL: string = "USER_ADMIN_UPDATE_FAIL";
export const USER_ADMIN_UPDATE_REQUEST: string = "USER_ADMIN_UPDATE_REQUEST";
export const USER_ADMIN_UPDATE_SUCCESS: string = "USER_ADMIN_UPDATE_SUCCESS";
