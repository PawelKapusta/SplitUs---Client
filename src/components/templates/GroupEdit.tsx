...
import { getListUsersOfGroup } from "../../store/actions/groupsActions";
...
const GroupEdit: React.FC<Props> = ({ group, handleClose, handleEditClick }) => {
    ...
    <div className={classes.root}>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormInput
          ...
          control={control}
          register={register}
          defaultValue={group.DataCreated}
